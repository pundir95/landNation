            ...
            <Row className="justify-content-center">
              <Col md={11}>
                ...
                <p className="why-text mb-5">
                  Maximize your property's exposure! Whether you're a realtor or
                  an owner, LandNation brings you closer to the right buyers.
                  List today for better leads and results.
                </p>
                    ...
                    <Col md={6}>
                      <div>
                        <p className="why-card-text mb-0">
                          Connecting professionals and owners with buyers and
                ...
                <div className="why-card py-4 px-md-5 px-4 mb-4">
                  <Row className="align-items-center">
                    ...
                    <Col md={6}>
                      <div>
                        <p className="why-card-text mb-0">
                          Our dashboard is a gateway to market data and insights
                          that positions you to optimize strategies and maximize
                          returns.
                        </p>
                      </div>
                    </Col>
